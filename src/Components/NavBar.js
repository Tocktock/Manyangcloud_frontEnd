  ...
  return (
	...
	<StyledNavBar svgIcon="/icons/16px/code.svg" svgUserIcon="/icons/16px/user.svg">
		...
		<div id="styled-navbar-content">
			...
			<div id="styled-navbar-content-title"> ManyangCloudDoc </div>
			...
			<Button text="My All Project"  btype="grey" onMouseEnter={ (e) => { e.stopPropagation(); getNavPosition(e, "project", false); }} />
